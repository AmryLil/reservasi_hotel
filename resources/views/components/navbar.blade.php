    ...
    <nav class="hidden md:flex items-center">
        <div class="flex space-x-1">
            <a href="/"
                ...
                Beranda
                <span class="absolute bottom-0 left-0 w-full h-0.5 bg-blue-600 transform scale-x-0 group-hover:scale-x-100 transition-transform {{ Request::is('/') ? 'scale-x-100' : '' }}"></span>
            </a>

            <a href="/shop"
                class="relative group px-4 py-2 {{ Request::is('shop') ? 'text-blue-600 font-medium' : 'text-gray-700' }}">
                Reservasi
                <span class="absolute bottom-0 left-0 w-full h-0.5 bg-blue-600 transform scale-x-0 group-hover:scale-x-100 transition-transform {{ Request::is('shop') ? 'scale-x-100' : '' }}"></span>
            </a>

            <a href="/kategori"
                class="relative group px-4 py-2 {{ Request::is('kategori') ? 'text-blue-600 font-medium' : 'text-gray-700' }}">
                Galery
                <span class="absolute bottom-0 left-0 w-full h-0.5 bg-blue-600 transform scale-x-0 group-hover:scale-x-100 transition-transform {{ Request::is('kategori') ? 'scale-x-100' : '' }}"></span>
            </a>

            <a href="/about"
                class="relative group px-4 py-2 {{ Request::is('about') ? 'text-blue-600 font-medium' : 'text-gray-700' }}">
                Tentang Kami
                <span class="absolute bottom-0 left-0 w-full h-0.5 bg-blue-600 transform scale-x-0 group-hover:scale-x-100 transition-transform {{ Request::is('about') ? 'scale-x-100' : '' }}"></span>
            </a>

            <a href="/contact-us"
                class="relative group px-4 py-2 {{ Request::is('contact-us') ? 'text-blue-600 font-medium' : 'text-gray-700' }}">
                Kontak
                <span class="absolute bottom-0 left-0 w-full h-0.5 bg-blue-600 transform scale-x-0 group-hover:scale-x-100 transition-transform {{ Request::is('contact-us') ? 'scale-x-100' : '' }}"></span>
            </a>
        </div>
    </nav>
    ...
    <div class="flex items-center space-x-4">
        ...
        <div x-data="{ open: false }" class="relative">
            ...
            <div x-show="open" x-transition class="absolute top-12 right-0 bg-white shadow-lg rounded-lg p-4 w-72">
                <div class="flex items-center bg-gray-100 rounded-lg px-3 py-2">
                    ...
                    <input type="text" placeholder="Cari produk..." class="bg-transparent border-none w-full focus:outline-none text-sm text-gray-700">
                </div>
        ...
        @if (Auth::check())
            ...
            <a href="{{ route('cart.view') }}" class="relative p-2 rounded-full hover:bg-gray-100 transition-colors">
                ...
                <span class="absolute top-0 right-0 inline-flex items-center justify-center w-4 h-4 text-xs font-bold text-white bg-blue-600 rounded-full">3</span>
            </a>
            ...
            <div class="drawer drawer-end z-50">
                ...
                <div class="drawer-content">
                    <label for="my-drawer-4" class="drawer-button">
                        <div class="flex items-center cursor-pointer space-x-2 border border-gray-200 rounded-full pr-3 pl-1 py-1 hover:bg-gray-50 transition-colors">
                            ...
                            <span class="text-sm font-medium text-gray-700 hidden sm:inline">{{ session('name') }}</span>
                ...
                <div class="drawer-side">
                    ...
                    <div class="min-h-full w-80 sm:w-96 bg-white overflow-y-auto">
                        ...
                        <nav class="p-4">
                            ...
                            <a href="{{ route('user.profile') }}" class="flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-gray-100 mb-1">
                            ...
                            <a href="{{ route('pesanan') }}" class="flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-gray-100 mb-1">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <a href="{{ route('transaksi.index') }}" class="flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-gray-100 mb-1">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <a href="{{ route('cart.view') }}" class="flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-gray-100 mb-1">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
                                </svg>
        ...
        @else
            ...
            <div class="flex items-center space-x-3">
                <a href="/login" class="text-gray-700 hover:text-blue-600 font-medium text-sm transition-colors">Login</a>
                <a href="/signup" class="bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-lg text-sm font-medium shadow-sm transition-colors">
                    Register
                </a>
            </div>
        @endif
...
<div class="fixed inset-0 bg-gray-900 bg-opacity-50 z-40 hidden" id="mobile-menu-overlay">
    <div class="fixed inset-y-0 right-0 max-w-xs w-full bg-white shadow-xl z-50 transform transition-transform duration-300">
