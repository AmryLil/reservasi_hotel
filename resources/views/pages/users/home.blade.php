...
@section('content')
        ...
        <div class="h-[500px] w-full overflow-hidden bg-blue-50">
            ...
            <div class="absolute inset-0 flex items-center z-20">
                <div class="container mx-auto px-6">
                    <div class="max-w-lg">
                        <h1 class="text-4xl md:text-5xl font-bold text-white leading-tight">Rasakan Kemewahan & Kenyamanan
                        </h1>
                        <p class="mt-4 text-blue-100 text-lg">Pesan liburan sempurna Anda di Ocean Blue Resort</p>
                        <button
                            class="mt-8 bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-6 rounded-md transition duration-300">
                            Booking Sekarang
                        </button>
                    </div>
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden transition duration-300 hover:shadow-xl">
                    <img src="https://img.freepik.com/free-photo/room-interior-hotel-bedroom_23-2150683421.jpg?t=st=1745150781~exp=1745154381~hmac=8740b252f8fb0d69af71f4b66fc6be9273832757f88e39d8a416a702065c4644&w=1800"
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mt-2">Kamar luas dengan pemandangan laut yang menakjubkan dan fasilitas
                            premium.</p>
                        <p class="text-blue-700 font-bold text-lg mt-4">Mulai dari Rp 2.000.000/malam</p>
                        <button
                            class="mt-4 w-full bg-blue-700 hover:bg-blue-800 text-white py-2 rounded transition duration-300">
                            Lihat Detail
                        </button>
                    </div>
                </div>
                ...
                <!-- Kamar 2 -->
                <div class="bg-white rounded-lg shadow-md overflow-hidden transition duration-300 hover:shadow-xl">
                    <img src="https://img.freepik.com/free-photo/cozy-studio-apartment-with-bedroom-living-space_1262-12323.jpg?t=st=1745150887~exp=1745154487~hmac=82cc13f5bfe303248368267f3999373468a9315e81d919b5b6839cc64320bd2d&w=1380"
                        alt="Suite Eksekutif" class="w-full h-56 object-cover">
                    <div class="p-6">
                ...
                <!-- Kamar 3 -->
                <div class="bg-white rounded-lg shadow-md overflow-hidden transition duration-300 hover:shadow-xl">
                    <img src="https://img.freepik.com/free-photo/full-shot-parents-kid-bed_23-2148974449.jpg?t=st=1745151006~exp=1745154606~hmac=a09f4b759b7e4b25d5536ed0410e1cd4b91321d52be90132794605a24c8ef66f&w=1380"
                        alt="Kamar Keluarga" class="w-full h-56 object-cover">
                    <div class="p-6">
        ...
        <div class="container mx-auto px-6 h-96 ">
            <div class="bg-blue-800 rounded-lg shadow-xl overflow-hidden">
                <div class="md:flex justify-center items-center">
                    <div class="md:w-1/2">
                        <img src="https://img.freepik.com/free-photo/hotel-receptionist-work_23-2149661556.jpg?t=st=1745151085~exp=1745154685~hmac=c8e95fb538e8ca2f19a0453a4ec96562674f5c2fce26f59fb1e3fb8ac9a8b8fa&w=740"
                            alt="Special Offer" class="w-full h-[410px] object-cover">
                    </div>
                    <div class="md:w-1/2 p-8 md:p-12 flex items-center">
                        <div>
                            <span
                                class="inline-block px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm font-semibold mb-4">Waktu
                                Terbatas</span>
                            <h2 class="text-3xl font-bold text-white mb-4">Paket Layanan Spesial Hotel</h2>
                            <p class="text-blue-100 mb-6">Nikmati pelayanan eksklusif kami dengan menginap minimal 3 malam:
                            </p>
                            <ul class="text-blue-100 space-y-2 mb-8">
                                <li class="flex items-center">
                                    <svg class="h-5 w-5 mr-2 text-blue-300" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M5 13l4 4L19 7" />
                                    </svg>
                            ...
                            <button
                                class="bg-white hover:bg-blue-100 text-blue-800 font-bold py-3 px-6 rounded-md transition duration-300">
                                Pesan Sekarang
                            </button>
                        </div>
                    </div>
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-6 rounded-lg shadow">
                    ...
                    <p class="text-gray-600 italic mb-4">"Kamarnya sangat nyaman dan pemandangan lautnya luar biasa. Staf
                        sangat membantu dan membuat pengalaman menginap kami sempurna."</p>
                ...
                <div class="bg-white p-6 rounded-lg shadow">
                    <div class="flex text-blue-500 mb-4">★★★★★</div>
                    <p class="text-gray-600 italic mb-4">"Semua mulai dari makanan hingga layanan spa sangat luar biasa.
                        Saya pasti akan kembali menginap lagi!"</p>
                    <div class="flex items-center">
                        <div class="bg-blue-100 w-10 h-10 rounded-full flex items-center justify-center mr-3">
                ...
                <div class="bg-white p-6 rounded-lg shadow">
                    <div class="flex text-blue-500 mb-4">★★★★★</div>
                    <p class="text-gray-600 italic mb-4">"Tempat liburan yang sempurna! Lokasinya tenang, kamar-kamarnya
                        indah, dan kolam infinity-nya luar biasa. Kami akan kembali musim panas mendatang!"</p>
                    <div class="flex items-center">
                        <div class="bg-blue-100 w-10 h-10 rounded-full flex items-center justify-center mr-3">
    ...
    <section class="py-12 bg-blue-900">
        <div class="container mx-auto px-6 text-center">
            ...
            <p class="text-blue-100 mb-8 max-w-2xl mx-auto">Pesan kamar Anda hari ini dan rasakan perpaduan sempurna antara
                kemewahan, kenyamanan, dan pelayanan istimewa.</p>
            <button
                class="bg-white hover:bg-blue-100 text-blue-800 font-bold py-3 px-8 rounded-md transition duration-300">
                Pesan Sekarang
            </button>
        </div>
    </section>
    ...
    <button id="scrollToTopButton"
        class="fixed bottom-8 right-8 bg-blue-700 text-white p-3 rounded-full shadow-lg cursor-pointer hidden hover:bg-blue-800 transition duration-300">
