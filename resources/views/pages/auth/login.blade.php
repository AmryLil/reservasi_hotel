                ...
                <div class="p-8">
                    ...
                    <form action="{{ route('login') }}" method="POST" class="space-y-4">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-sm">
                                <a href="#" class="font-medium text-blue-600 hover:text-blue-500">Forgot
                                    password?</a>
                            </div>
                        </div>
                    ...
                    <div class="mt-6 text-center text-sm text-blue-600">
                        ...
                        <a href="{{ route('signup.form') }}" class="text-blue-800 font-semibold hover:underline">Create
                            Account</a>
                    </div>
                    ...
                    <div class="flex justify-center space-x-4">
                        <button
                            class="flex items-center justify-center p-2 rounded-full border border-blue-200 bg-white hover:bg-blue-50 transition-colors">
